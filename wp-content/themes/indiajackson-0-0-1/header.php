...
<html lang="en-GB">
	...
	<head>
		...
		<meta name="author" content="India Jackson">
		<link rel="author" href="http://indiajackson.co.uk">
	...
	<body>
		<header id="site-header">
			...
			<main role="main" class="container <?php if(is_front_page()): echo 'front-page'; else: echo 'container'; endif; ?>">